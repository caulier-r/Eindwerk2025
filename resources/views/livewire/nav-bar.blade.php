                    ...
                    @auth
                        ...
                        <div class="relative ml-3" x-data="{ open: false }">
                            ...
                            <div x-show="open"
                                 ...
                                 class="absolute right-0 z-10 mt-2 w-52 origin-top-right rounded-md bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                 style="display: none;"
                                 role="menu"
